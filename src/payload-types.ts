...
export interface AboutBlock {
  /**
   * The main headline for the about section
   */
  title?: string | null;
  /**
   * Small label above the main title (e.g., "Company Introduction")
   */
  companyIntroLabel?: string | null;
  /**
   * The main company story/description text
   */
  ...
  subtitle?: string | null;
  /**
   * Description text for the about/who we are section
   */
  description?: string | null;
  /**
  ...
  stats?:
    | {
        ...
        value?: string | null;
        /**
         * e.g., "Quick Installation" or "24/7 Support" or "High Speed Internet"
         */
        label?: string | null;
        id?: string | null;
      }[]
  ...
  image?: (number | null) | Media;
  /**
   * Values grid items (recommended: 3 items)
   */
  values?:
    | {
        title: string;
