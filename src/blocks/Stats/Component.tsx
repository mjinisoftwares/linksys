...
const StatsBlock: React.FC<Props> = ({ className, heading, stats }) => {
  return (
    <section
      className={cn('bg-primary text-background py-12 px-6 sm:px-6 md:px-12 lg:px-16 ', className)}
    >
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 max-w-7xl mx-auto">
        {stats?.map((stat, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center p-6 bg-[#002b40]/50 rounded-xl shadow-md"
          >
